...
$requette = "SELECT ncc FROM communes ORDER BY dep ASC";
    ...
    <div class="u-clearfix u-gutter-0 u-layout-wrap u-layout-wrap-1">
        <div class="u-gutter-0 u-layout">
            <div class="u-layout-row">
                <div class="u-align-left u-container-style u-layout-cell u-size-55 u-layout-cell-1">
                    <div class="u-container-layout u-valign-bottom u-container-layout-1">
                        <div id="map" class="u-clearfix u-custom-html u-custom-html-1">
                            <script>
                                //Recuperation des couches de la page getCommunes
                                ...
                                //Definition de la fonction de transformation des liste en Géojson
                                ...
                                //Transformation des listes en Couche Géojson
                                let centreComFeatures = getGeoJSON(centreCommercial);
                                let communeFeatures = getGeoJSON(Communes);
                                ...
                                var argisLayer= L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}');

                                //Ajout des couches Géojson
                                var centreCom=L.geoJSON(centreComFeatures,{
                                ...
                                var commune=L.geoJSON(communeFeatures,{
                                    style:styleCommune
                                });
                                var commerce=L.geoJSON(commerceFeatures,{
                                    //Ajout du marqueur à la couche
                                    pointToLayer: function(feature, latlng) {
                                                //Definition d'une variable icon
                                                var commerceIcon = new L.icon({
                                ...
                                var region=L.geoJSON(regionFeatures,{
                                    style:styleRégion
                                });
                                //création de map options
                                var mapOptions = {
                                    center: [48.6794108,1.9422427],
                                    zoom: 8,
                                    layers: [osmLayer]
                                }
                                ...
                                legend.onAdd = function (map) {
                                    ...
                                    div.innerHTML += "<h4><strong>Légende</strong></h4>";
                ...
                <!--div-- class="u-align-left u-container-style u-layout-cell u-palette-1-dark-1 u-radius-29 u-shape-round u-size-17 u-layout-cell-2"
                     data-animation-name="flash" data-animation-duration="1000" data-animation-delay="0"
                     data-animation-direction="">
                    <div class="u-container-layout u-valign-top u-container-layout-2">
                        <h2 class="u-custom-font u-font-oswald u-text u-text-body-alt-color u-text-1">Legende des données disponible pour consultation</h2>
                        <div class="u-form u-form-1">
                            <p>Ici la legende de la carte</p>
                        </div>
                    </div>
                </div-->
            </div>

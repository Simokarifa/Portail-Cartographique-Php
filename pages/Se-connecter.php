...
<section class="u-align-center u-clearfix u-palette-1-light-3 u-section-1" id="sec-9aac">
    <div class="u-clearfix u-sheet u-sheet-1">
        <div class="u-form u-form-1">
            <form action="#" method="POST" class="u-clearfix u-form-horizontal u-form-spacing-15 u-inner-form"
                ...
                <div class="u-form-email u-form-group u-form-group-2">
                    <label for="email-558c" class="u-form-control-hidden u-label">Adresse mail ou nom d'utilisateur</label>
                    <input type="email" placeholder="Adresse mail ou nom d'utilisateur" id="email-558c" name="email"
                           class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
                </div>
                <div class="u-form-group u-form-name u-form-group-1">
                    <label for="name-558c" class="u-form-control-hidden u-label">Mot de passe de connexion</label>
                    <input type="password" placeholder="Mot de passe de connexion" id="name-558c" name="mdp"
                           class="u-border-1 u-border-grey-30 u-input u-input-rectangle" required="">
                </div>
                ...
                <div class="u-form-send-message u-form-send-success">Connexion reussit ! Merci pour votre visite sur notre site</div>
                <div class="u-form-send-error u-form-send-message">Erreur de connexion veuillez reessayer</div>
                <input type="hidden" value="" name="recaptchaResponse">
            </form>
            <a class="u-link" href="inscription.php" target="_blank">
        ...
        <div class="u-align-left u-social-icons u-spacing-10 u-social-icons-1">
            <a class="u-social-url" title="facebook" target="_blank" href=""><span
                    class="u-icon u-icon-circle u-social-facebook u-social-icon u-icon-1"><svg class="u-svg-link"
                        ...
                        class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-3a48"><circle fill="currentColor"
                                                                                                      cx="56.1" cy="56.1"
                                                                                                      r="55"></circle><path
            ...
            <a class="u-social-url" title="twitter" target="_blank" href=""><span
                    class="u-icon u-icon-circle u-social-icon u-social-twitter u-icon-2"><svg class="u-svg-link"
                        ...
                        class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-5aa8"><circle fill="currentColor"
                                                                                                      class="st0" cx="56.1"
                                                                                                      cy="56.1"
                                                                                                      r="55"></circle><path
            ...
            <a class="u-social-url" title="instagram" target="_blank" href=""><span
                    class="u-icon u-icon-circle u-social-icon u-social-instagram u-icon-3"><svg class="u-svg-link"
                        ...
                        class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-feeb"><circle fill="currentColor"
                                                                                                      cx="56.1" cy="56.1"
                                                                                                      r="55"></circle><path
            ...
            <a class="u-social-url" title="linkedin" target="_blank" href=""><span
                    class="u-icon u-icon-circle u-social-icon u-social-linkedin u-icon-4"><svg class="u-svg-link"
                        ...
                        class="u-svg-content" viewBox="0 0 112 112" x="0" y="0" id="svg-2ad5"><circle fill="currentColor"
                                                                                                      cx="56.1" cy="56.1"
                                                                                                      r="55"></circle><path
